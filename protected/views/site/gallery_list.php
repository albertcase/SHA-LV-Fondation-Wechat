...
var infoArr = {
	...
	"g2": "<p>艾尔华斯·凯利（Ellsworth Kelly），国际艺术舞台最重要的角色之一，完成了一次独有、全面和永久的参与。黄色、红色、蓝色、绿色和紫色，5个搭配舞台幕布的单色板在空间中营造 出纯净而跳跃的色调。由12快板构成的幕布与缤纷的色彩相映成趣。这件作品是凯利以自己的大型系列绘画“Spectrum”为素材而创作的，该系列的第一 幅画作于1953年在巴黎完成。作品的设计构思与弗兰克·盖里（Frank Gehry）的建筑交相呼应，灵活运用线条、体积和尺寸突出展示了建筑物的结构。艺术、建筑与音乐在演播厅里互动共鸣，缔造了一次绝无仅有的体验。 </p>",
