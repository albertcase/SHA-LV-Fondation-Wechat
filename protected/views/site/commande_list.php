...
var infoArr = {
	"g0": "<p>这件雕塑作品的题目，“奴隶生活的地方”（Where the Slaves Live），源自“ vernaculaire ”（“乡土”）的拉丁语词根“ verna ”（意为“奴隶”）。这件作品的外形颇为神秘，好似蓄水池，这也是安德里昂·维拉尔·若加斯（Adrian Villar Rojas）惯用的题材。带着一种超越时间的奇艺色彩，这件作品被设计成一个着陆在地球上的“小小星球”，不着痕迹地将考古学与科幻合为一体。</p><p>“奴隶生活的地方”由若干层来自世界各地的有机和无机材料（泥土、颜料、植物、蔬菜、石头、炭渣、水泥、青草、化石、珊瑚、面包、水果、衣物、鞋履等）构成，堪称是一件“活的雕塑”，随着时间的流转而不断变化。在这个生态系统中，艺术家在雕塑中嵌入了个人痕迹，令人不禁想到人类的存在。人类成为大自然及其 演化不可分割的部分，和大自然一道经历着从未停止过的嬗变。</p>",
	"g1": "<p>这件声音雕塑运用有形与无形，将手工技艺与数字工具相结合，由 20 根透明的玻璃笛子组成，笛子又由长长的管子延续至一个保留了原貌的风箱。这些笛子形成悬空的椭圆，在不同的高度层层排列，每一根笛子按照艺术家呼应建筑结构所创作的乐曲奏响一个音调。不断振动的音轨交错相交。</p><p>赛瑞斯·维恩·埃文斯（Cerith Wyn Evans，1958 年，英国）在伦敦生活和工作。</p>",
